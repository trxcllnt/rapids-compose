...
export CUDF_JAVA_INCLUDE="$CUDF_HOME/java/src/main/native/include"
...
export CUDF_JAVA_ROOT_ABS="$CUDF_HOME/java/src/main/native/$(cpp-build-dir $CUDF_HOME)"
...
export CUDF_JAVA_ROOT="$CUDF_HOME/java/src/main/native/build/$(basename "$CUDF_JAVA_ROOT_ABS")"

export RMM_LIBRARY="$RMM_ROOT/librmm.so"
export CUDF_LIBRARY="$CUDF_ROOT/libcudf.so"
export CUDF_JAVA_LIBRARY="$CUDF_JAVA_ROOT/libcudfjni.so"
...
make-symlink "$CUDF_JAVA_ROOT_ABS" "$CUDF_JAVA_ROOT"
